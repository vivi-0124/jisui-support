...
export const buttonVariants = tv({
  ...
  variants: {
    theme: {
      ...
      ingredients: "bg-green-600 hover:bg-green-700 text-white shadow-lg hover:shadow-xl",
      shopping: "bg-purple-600 hover:bg-purple-700 text-white shadow-lg hover:shadow-xl", 
      recipes: "bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl",
      search: "bg-orange-600 hover:bg-orange-700 text-white shadow-lg hover:shadow-xl"
    },
    variant: {
      solid: "",
...
export const gradientButtonVariants = tv({
  ...
  variants: {
    theme: {
      ...
      ingredients: "bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700", 
      shopping: "bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700",
      recipes: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700",
      search: "bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700"
    },
    size: {
      sm: "h-10 w-10",
      md: "h-12 w-12", 
